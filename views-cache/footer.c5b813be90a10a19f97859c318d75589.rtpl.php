...
<!-- jQuery sticky menu -->
<script src="/recursos-template/site/js/owl.carousel.min.js"></script>
<script src="/recursos-template/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/recursos-template/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/recursos-template/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/recursos-template/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="/recursos-template/site/js/script.slider.js"></script>
</body>
</html>
